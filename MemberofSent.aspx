<%@ Page language="c#" Codebehind="MemberofSent.aspx.cs" AutoEventWireup="false" Inherits="CENTASMS.MemberofSent" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
				...
				<tr align="center">
					<td align="center">
						<asp:DataGrid id="dgMembers" runat="server" AutoGenerateColumns="False" AllowPaging="True" Width="450px"
							Height="90%" meta:resourcekey="dgMembersResource1">
						...
						<%# DataBinder.Eval(Container, "DataItem.IREC_NO") %>
								...
								<asp:TemplateColumn HeaderText="<%$ Resources:MOSGroupName %>">
									<HeaderStyle HorizontalAlign="Left" Width="80px" CssClass="grid-header" VerticalAlign="Middle"></HeaderStyle>
								...
								<asp:TemplateColumn HeaderText="<%$ Resources:MOSMobile %>">
									<HeaderStyle HorizontalAlign="Left" Width="80px" CssClass="grid-header" VerticalAlign="Middle"></HeaderStyle>
									<ItemStyle Width="80px" CssClass="grid-item"></ItemStyle>
									<ItemTemplate>
