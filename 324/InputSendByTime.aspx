...
<%@ Page language="c#" Codebehind="InputSendByTime.aspx.cs" AutoEventWireup="false" Inherits="CENTASMS.InputSendByTime" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
{
    alert('<%= GetLocalResourceObject("AlertMsg").ToString() %>');
obj.focus();
return (false);
} 
				...
				<tr>
					<td style="HEIGHT: 125px">
						<table style="WIDTH: 327px; HEIGHT: 79px" cellSpacing="0" cellPadding="0" align="center"
							border="0">
							<tr>
								<td style="WIDTH: 72px" align="right"><STRONG><asp:Literal runat="server" Text="<%$ Resources:IBTDate %>"/></STRONG></td>
								<td style="WIDTH: 104px"><asp:textbox id="tbScheduleDate"  runat="server" onChange="return CheckDate(this)"  Width="120px" meta:resourcekey="tbScheduleDateResource1"></asp:textbox><STRONG></STRONG></td>
								<td style="WIDTH: 69px" align="right"><FONT face="新細明體"><STRONG><asp:Literal runat="server" Text="<%$ Resources:IBTTime %>"/></STRONG></FONT></td>
								<td><asp:textbox id="tbTime" runat="server" Width="120px" onChange="return CheckTime(this)" meta:resourcekey="tbTimeResource1"></asp:textbox></td>
							</tr>
							<tr>
								<td style="WIDTH: 72px"><FONT face="新細明體">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT></td>
								<td style="WIDTH: 104px" align="right"><FONT face="新細明體"></FONT></td>
								<td style="WIDTH: 69px" align="right"><FONT face="新細明體"><anthem:button id="btnSaveData" runat="server" Width="50px" Text="Save" meta:resourcekey="btnSaveDataResource1"></anthem:button></FONT></td>
