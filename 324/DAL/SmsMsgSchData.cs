namespace CENTASMS.DAL
{
    ...
    public class SmsMsgSchData : DataSet
    {
        ...
        public const string SMS_MSG_SCH = "SMS_MSG_SCH";

        public SmsMsgSchData()
        {
            this.BuildDataTables();
        }

        private SmsMsgSchData(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }

        private void BuildDataTables()
        {
            DataTable table = new DataTable("SMS_MSG_SCH");
