							...
							<tr vAlign="top">
								...
								<td vAlign="top"><anthem:panel id="panel1" runat="server" Visible="False" meta:resourcekey="panel1Resource1">
										<TABLE class="tan-border02" style="WIDTH: 100%; BORDER-COLLAPSE: collapse; HEIGHT: 380px"
											...
											<TR  vAlign="bottom" style="height:28px">
												<TD style="WIDTH: 240px"  align="left" height="1"> 
													<ASP:LABEL id="lbGroupPP" runat="server" Width="200px" Font-Size="Small" Font-Bold="true" meta:resourcekey="lbGroupPPResource1">添加私人組別：</ASP:LABEL></TD>
												<TD  style="WIDTH: 240px"   align="left" height="1">
										...
										<TABLE class="tan-border02" style="WIDTH: 100%; BORDER-COLLAPSE: collapse; HEIGHT: 380px"
											...
											<TR vAlign="bottom" style="height:28px">
												<TD style="WIDTH: 240px"  align="left" height="1"> 
													<ASP:LABEL id="lbGroupS" runat="server" Width="200px" Font-Bold="True" Font-Size ="Small" meta:resourcekey="lbGroupSResource1">添加共享組別：</ASP:LABEL></TD>
												<TD style="WIDTH: 240px"   align="left" height="1"><FONT face="新細明體">
												...
												<TD style="WIDTH:100px"   align="left" height="1">
										...
										<TABLE class="tan-border02" style="WIDTH: 100%; BORDER-COLLAPSE: collapse; HEIGHT: 380px"
											...
											<TR  vAlign="bottom"  style="height:28px">
												<TD style="WIDTH: 200px"  align="left" height="1">  
                                                    <ASP:LABEL id="Label9" runat="server" Width="200px" Font-Bold="True" Font-Size ="Small"  meta:resourcekey="Label9Resource1">組別類型  ：</ASP:LABEL> </TD>
												...
												<TD vAlign="top" align="left" width="50%" colSpan="8" height="256">
													<anthem:DATAGRID id="dgdata4" runat="server" Width="98%" AutoGenerateColumns="False" AllowPaging="True" meta:resourcekey="dgdata4Resource1">
														<Columns>
                                                            ...
                                                            <asp:TemplateColumn Visible ="false" HeaderText="ITEM_NO">
                                                                <ItemTemplate>
										...
										<TABLE class="tan-border02" style="WIDTH: 100%; BORDER-COLLAPSE: collapse; HEIGHT: 380px"
											...
											<TR>
												...
												<TD align="center" height="1">
													<TABLE style="HEIGHT: 142px" borderColor="#edecd1" cellSpacing="1" cellPadding="0" rules="none"
														...
														<TR>
															<TD style="HEIGHT: 1px" align="center" width="50%"></TD>
														...
														<TR>
															...
															<TD align="left" width="50%"><INPUT id="btnCannel" runat="server"    onclick="Clear()" type="button" value="重置" name="btnCannel">
											...
											<TR width="100%">
												<TD vAlign="top" align="left" width="50%" colSpan="3" height="1"></TD>
											</TR>
											<TR width="100%">
												<TD colSpan="3"></TD>
											</TR>
											...
											<TR>
												...
												<TD align="center" colSpan="3" height="1"><FONT face="新細明體">
														<TABLE id="Table4" borderColor="#edecd1" height="100%" cellSpacing="1" cellPadding="0"
															rules="none" width="98%" align="left" border="1">
															<TR vAlign="middle">
																<TD style="WIDTH: 10px" vAlign="baseline" align="left" height="1"></TD>
																<TD align="right" height="1" >
																	<ASP:LABEL id="Label2" runat="server" Width="200px" Font-Bold="True" meta:resourcekey="Label2Resource1">選擇組別類型：</ASP:LABEL></TD>
																<TD style="WIDTH: 118px; HEIGHT: 1px" align="left" height="1">
																	<anthem:RADIOBUTTON id="rbGroupP" Width="300px" runat="server" Text="私人組別" AutoCallBack="True" Checked="True" meta:resourcekey="rbGroupPResource1"></anthem:RADIOBUTTON></TD>
																<TD style="HEIGHT: 24px" align="left" height="24">
																	<anthem:RADIOBUTTON id="rbGroupS" Width="300px" runat="server" Text="共享組別" AutoCallBack="True" meta:resourcekey="rbGroupSResource1"></anthem:RADIOBUTTON></TD>
															...
															<TR>
																...
																<TD align="right" height="1">
																	<ASP:LABEL id="Label7" runat="server" Width="200px" Font-Bold="True" meta:resourcekey="Label7Resource1">上傳方式：</ASP:LABEL></TD>
																<TD style="WIDTH: 118px" align="left" height="1">
																	<anthem:RADIOBUTTON id="rbTypeAdd" runat="server" Width="300px" Text="新增上傳組別的號碼" AutoCallBack="True"
																		Checked="True" meta:resourcekey="rbTypeAddResource1"></anthem:RADIOBUTTON></TD>
																<TD align="left" height="1">
																	<anthem:RADIOBUTTON id="rbTypeCover" runat="server" Width="300px" Text="上傳覆蓋組別的號碼" AutoCallBack="True" meta:resourcekey="rbTypeCoverResource1"></anthem:RADIOBUTTON></TD>
																<TD align="left" width="15%" height="1">
																	<anthem:BUTTON id="btnUpload" runat="server" Visible="False" Width="60px" Text="上傳" meta:resourcekey="btnUploadResource1"></anthem:BUTTON></TD>
																<TD align="left" width="15%" height="1"></TD>
															</TR>
															<TR>
																<TD style="WIDTH: 10px"  height="10"></TD>
																<TD style="WIDTH: 200px" align="left" height="1"></TD>
																<TD style="WIDTH: 300px" align="left" height="1"></TD>
																<TD align="left"  style="WIDTH: 300px"></TD>
																<TD align="left" width="10%" height="1"></TD>
																<TD align="left" width="10%" height="1"></TD>
															</TR>
															<TR>
																<TD style="WIDTH: 10px; HEIGHT: 23px" height="23"></TD>
																<TD style="HEIGHT: 23px" align="right" height="23">
																	<ASP:LABEL id="Label8" runat="server" Width="130px" Font-Bold="True" meta:resourcekey="Label8Resource1">EXCEL/CSV 附件         ：</ASP:LABEL></TD>
																<TD style="HEIGHT: 23px" align="left" colSpan="2" height="23"><INPUT id="btnUploadMode" type="file"  accept="application/msexcel,application/csv" runat="server"><anthem:Label ID="lbrfvUpload" runat="server" ForeColor="Red" meta:resourcekey="lbrfvUploadResource1" Visible="False">   *</anthem:Label>      </TD>
																<TD style="HEIGHT: 23px" align="left" width="15%" height="23"><INPUT id="Submit1" runat="server"  style="WIDTH: 60px; HEIGHT: 24px" type="submit" value="上傳"></TD>
																<TD style="HEIGHT: 23px" align="left" width="15%" height="23"></TD>
															</TR>
															<TR bgColor="#edecd1"  valign ="bottom" >
																<TD style="WIDTH: 10px" height="10"></TD>
																<TD align="right" height="1"></TD>
																<TD align="left" colSpan="3" height="1"><anthem:LABEL id="lbUploadResult" runat="server" Visible="False" Width="100%" ForeColor="Red" meta:resourcekey="lbUploadResultResource1"></anthem:LABEL> </TD>
																<TD align="left" height="1"></TD>
															</TR>
															<TR> 
																<TD align="center" colSpan="6" height="1" style="WIDTH: 500px">
																		<DIV id="div_load" runat="server"><IFRAME src="UploadRefresh.aspx" frameBorder="no" width="100%" height="500px"><TABLE class="font" style="FILTER: Alpha(opacity=80); WIDTH: 152px; HEIGHT: 42px" borderColor="#cccccc"
																					 cellSpacing="1" cellPadding="5" width="500" border="0">
																					<TR>
																						<TD style="WIDTH: 55px">
																							<P>
										...
										<TABLE class="tan-border02" style="WIDTH: 100%; BORDER-COLLAPSE: collapse; HEIGHT: 380px"
											cellSpacing="10" cellPadding="0" rules="none" align="left" border="0">
											 	<TR style="height:6px"  >
												<TD vAlign="baseline" align="right" width="80"  > 
															<ASP:LABEL id="Label11" runat="server" Visible="False" Width="112px" Font-Bold="True" meta:resourcekey="Label11Resource1">添加聯絡人 ：</ASP:LABEL> 
                                                 </TD>
												<TD align="left" width="80" height="1"> </TD>
												<TD align="left" width="220" height="1"> </TD>
												<TD align="left" height="1"></TD>
												<TD align="left" width="1%" height="1"></TD>
											</TR>
											<TR>
												<TD vAlign="baseline" align="right" width="80" height="1"> </TD>
												<TD align="right" width="80" height="1"> <asp:Literal runat="server" Text="<%$ Resources:GASelectGroup %>"/>  </TD>
												...
												<TD align="left" height="1"> 
														<ASP:BUTTON id="btnAdd" runat="server" Text="添加" meta:resourcekey="btnAddResource1"></ASP:BUTTON> </TD>
												<TD align="left" width="1%" height="1"></TD>
											</TR>
											<TR>
												<TD vAlign="baseline" align="right" width="80" height="1"> </TD>
												<TD align="right" width="80" height="1"> <asp:Literal runat="server" Text="<%$ Resources:GAName %>"/> </TD>
												<TD align="left" width="220" height="1">
											...
											<TR>
												<TD vAlign="baseline" align="right" width="80" height="1"></TD>
												<TD align="right" width="80" height="1"> <asp:Literal runat="server" Text="<%$ Resources:GAMobile %>"/> </TD>
												<TD align="left" width="220" height="1">
												...
												<TD align="left" height="1"> 
														...
														<anthem:LABEL id="lbMsg6" runat="server" Width="240px" ForeColor="Red" meta:resourcekey="lbMsg6Resource1"></anthem:LABEL> </TD>
												<TD align="left" width="1%" height="1"></TD>
											</TR>
											<TR style="height:6px"  >
