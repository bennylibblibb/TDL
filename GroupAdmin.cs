...
//        protected TextBox TextBox3;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if ((this.txtName.Text.Trim() != "") && (this.txtMobile.Text.Trim() != ""))
            {
                if (this.dplGroups.SelectedItem.Text.Trim() != "All")
                {
                    ...
                    {
                        this.lbMsg6.Text = (Session["LanguageEn"] == "en-US") ? "Add success！" : "新增聯絡人成功!"; //"新增聯絡人成功!";
                    ...
                    {
                        this.lbMsg6.Text = (Session["LanguageEn"] == "en-US") ? "Add failed！" : "新增聯絡人失敗，號碼已存在!"; //"新增聯絡人失敗，號碼已存在!";
                    }
                }
                else
                {
                    this.lbMsg6.Text = (Session["LanguageEn"] == "en-US") ? "Please select group！" : "請選擇聯絡人組別!";// "請選擇聯絡人組別!";
                }
            }
            this.lbrfvmobile.UpdateAfterCallBack = true;
            this.lbrfvname.UpdateAfterCallBack = true;
        ...
        private void btnAddGroupP_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    this.lbMsgP.Text = (Session["LanguageEn"] == "en-US") ? "Add success！" : "新增私人組別成功";//"新增私人組別成功!";
                ...
                {
                    this.lbMsgP.Text = (Session["LanguageEn"] == "en-US") ? "Add failed！" : "新增組別失敗，私人組別名稱已存在!";///"新增組別失敗，私人組別名稱已存在!";
                }
        ...
        private void btnAddGroupS_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (groups.BoolExistShareGroupName(this.txtGroupS.Text.Trim()))
                {
                    ...
                    {
                        this.lbMsgS.Text = (Session["LanguageEn"] == "en-US") ? "Add success！" : "新增共享組別成功!"; //"新增共享組別成功!";
                    ...
                    {
                        this.lbMsgS.Text = (Session["LanguageEn"] == "en-US") ? "Add failed！" : "新增組別失敗!";// "新增組別失敗，共享組別名稱已存在!";
                    }
                }
                else
                {
                    this.lbMsgS.Text = (Session["LanguageEn"] == "en-US") ? "Add failed！" : "新增組別失敗，共享組別名稱已存在!";// "新增組別失敗，共享組別名稱已存在!";
                }
        ...
        private void btnDeleteMember_Click(object sender, EventArgs e)
        {
            ...
            if (memberDatabyAdminatMemberPage.Tables[0].Rows.Count > 0)
            {
                ...
                if (flag)
                {
                    this.lbMsg6.Text = (Session["LanguageEn"] == "en-US") ? "Delete success！" : "刪除成功"; //"刪除聯絡人成功！";
                    this.dgMember.CurrentPageIndex = 0;
                ...
                {
                    this.lbMsg6.Text = (Session["LanguageEn"] == "en-US") ? "Delete failed！" : "刪除聯絡人失敗";// "刪除聯絡人失敗！";
                }
            }
            else
            {
                this.lbMsg6.Text = (Session["LanguageEn"] == "en-US") ? "Delete failed(have no record)！" : "刪除成功"; //"組別中不存在聯絡人！";
            }
            this.lbMsg6.UpdateAfterCallBack = true;
        }
            ...
            try
            {
                if (this.dgData.Items.Count > 0)
                {
                    using (FbConnection connection = new FbConnection(AppFlag.CENTASMSINTEConn))
                    {
                        ...
                        this.lbMsgP.Text = (Session["LanguageEn"] == "en-US") ? "Delete success！" : "刪除成功"; //"刪除成功!";
                        this.GetGroupbyOwnerAndType(this.Context.User.Identity.Name, "P");
                    }
                }
                else
                {
                    this.lbMsgP.Text = (Session["LanguageEn"] == "en-US") ? "Delete failed(have no record)！" : "無私人組別&聯絡人!";// "無私人組別&聯絡人!";
                }
            }
            catch (Exception exception)
            {
                this.lbMsgP.Text = (Session["LanguageEn"] == "en-US") ? "Delete failed！" : "刪除失敗";// "刪除不成功!";
            ...
            try
            {
                if (this.dgData2.Items.Count > 0)
                {
                    using (FbConnection connection = new FbConnection(AppFlag.CENTASMSINTEConn))
                    {
                        ...
                        if ((num + num2) > 0)
                        {
                            this.lbMsgS.Text = (Session["LanguageEn"] == "en-US") ? "Delete success！" : "刪除成功";// "刪除成功!";
                            this.GetGroupbyOwnerAndType(this.Context.User.Identity.Name, "S");
                        }
                        else
                        {
                            this.lbMsgS.Text = (Session["LanguageEn"] == "en-US") ? "Delete failed！" : "刪除失敗"; //"刪除不成功!";
                        }
                    }
                }
                else
                {
                    this.lbMsgS.Text = (Session["LanguageEn"] == "en-US") ? "Delete failed(have no record)！" : "無共享組別&聯絡人"; //"無共享組別&聯絡人!";
                }
            }
            catch (Exception exception)
            {
        ...
        private void btnSaveRight_Click(object sender, EventArgs e)
        {
            ...
            if (flag)
            {
                this.lbRightResult.Text = (Session["LanguageEn"] == "en-US") ? "Update success！" : "設置成功！";// "設置成功!";
                Files.CicsWriteLog(DateTime.Now.ToString("HH:mm:ss") + "  (" + this.Context.User.Identity.Name + ")  設置有共享組別權限：" + str + "！");
            }
            else
            {
                this.lbRightResult.Text = (Session["LanguageEn"] == "en-US") ? "Update failed！" : "設置失敗！";// "設置失敗!";
            }
            ...
            if (str2 != "")
            {
                ...
                if (flag)
                {
                    if (this.doload.State != 1)
                    {
                        ...
                        row["CSMS_ACTION_STATUS"] = (Session["LanguageEn"] == "en-US") ? "Doing" : "進行中";// "進行中";
                ...
                {
                    this.doload.dolbUploadResult = (Session["LanguageEn"] == "en-US") ? "Upload failed！" : "上載失敗！";// "上載失敗 ！";
        ...
        {
            if (this.cbCheckAll.Text == ((Session["LanguageEn"] == "en-US") ? "Select All" : "全選"))
            {
                this.cbCheckAll.Text = (Session["LanguageEn"] == "en-US") ? "Select No" : "全不選";// "全不選";
            }
            else
            {
                this.cbCheckAll.Text = (Session["LanguageEn"] == "en-US") ? "Select All" : "全選"; //"全選";
            }
        ...
        private void dgData_DeleteCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            if (AppFlag.DeteleGroupMode == "ALL")
            {
                using (FbConnection connection = new FbConnection(AppFlag.CENTASMSINTEConn))
                {
                    ...
                    this.lbMsgP.Text = (Session["LanguageEn"] == "en-US") ? "Delete " + str2 + " success！" : "刪除 " + str2 + " 私人組別&聯絡人成功!";// "刪除 " + str2 + " 私人組別&聯絡人成功!";
                }
            }
            else if (new GroupMembers().GetMemberDataByGroupID(text).Tables[0].Rows.Count == 0)
            {
                ...
                {
                    this.lbMsgP.Text = (Session["LanguageEn"] == "en-US") ? "Delete success！" : "刪除私人組別成功！";//"刪除私人組別成功！";
            ...
            {
                this.lbMsgP.Text = (Session["LanguageEn"] == "en-US") ? "Delete failed,member existed！" : "組別中已存在成員，刪除私人組別失敗！！";// "組別中已存在成員，刪除私人組別失敗！";
            }
            this.GetGroupbyOwnerAndType(this.lbUser.Text.Trim(), "P");
            this.lbMsgP.UpdateAfterCallBack = true;
        }
        ...
        private void dgData_UpdateCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                this.lbMsgP.Text = (Session["LanguageEn"] == "en-US") ? "Update success！" : "更新私人組別成功!";//"更新私人組別成功!";
                Files.CicsWriteLog(DateTime.Now.ToString("HH:mm:ss") + "  (" + this.Context.User.Identity.Name + ")  更新私人組別名稱 " + str3 + " 至 " + str4 + "！");
            }
            else
            {
                this.lbMsgP.Text =(Session["LanguageEn"] == "en-US") ? "Update failed！" : "更新私人組別失敗!";// "更新私人組別失敗!";
            }
            this.GetGroupbyOwnerAndType(this.lbUser.Text.Trim(), "P");
            this.lbMsgP.UpdateAfterCallBack = true;
        }
        ...
        private void dgData2_DeleteCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            if (AppFlag.DeteleGroupMode == "ALL")
            {
                using (FbConnection connection = new FbConnection(AppFlag.CENTASMSINTEConn))
                {
                    ...
                    if ((num + num2) > 0)
                    {
                        this.lbMsgS.Text = (Session["LanguageEn"] == "en-US") ? "Delete " + str2 + " success！" : "刪除 " + str2 + " 共享組別&聯絡人成功!"; //"刪除 " + str2 + " 共享組別&聯絡人成功!";
                    }
                    else
                    {
                        this.lbMsgS.Text = (Session["LanguageEn"] == "en-US") ? "Delete " + str2 + " failed！" : "刪除 " + str2 + " 共享組別&聯絡人不成功!";// "刪除 " + str2 + " 共享組別&聯絡人不成功!";
                    }
                }
            }
            else if (new GroupMembers().GetMemberDataByGroupID(text).Tables[0].Rows.Count == 0)
            {
                ...
                if (groups.DeleteGroup(data))
                {
                    this.lbMsgS.Text = (Session["LanguageEn"] == "en-US") ? "Delete success！" : "刪除共享組別成功！";//"刪除共享組別成功！";
                    Files.CicsWriteLog(DateTime.Now.ToString("HH:mm:ss") + "  (" + this.Context.User.Identity.Name + ")  刪除共享組別 " + str2 + " ！");
                }
                else
                {
                    this.lbMsgS.Text = (Session["LanguageEn"] == "en-US") ? "Delete failed！" : "刪除共享組別失敗！";// "刪除共享組別失敗！";
                }
            }
            else
            {
                this.lbMsgS.Text = (Session["LanguageEn"] == "en-US") ? "Delete failed,member existed！" : "組別中已存在成員，刪除共享組別失敗！";// "組別中已存在成員，刪除共享組別失敗！";
            }
            this.GetGroupbyOwnerAndType(this.lbUser.Text.Trim(), "S");
            this.lbMsgS.UpdateAfterCallBack = true;
        }
        ...
        private void dgData2_UpdateCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            if ((groups.BoolExistShareGroupName(groupname) && (groupname != Groups.GetGroupNamebyGroupID(id))) || (groupname == Groups.GetGroupNamebyGroupID(id)))
            {
                ...
                if (new Groups().UpdateGroup(data))
                {
                    this.lbMsgS.Text =(Session["LanguageEn"] == "en-US") ? "Update success！" : "更新共享組別成功!"; //"更新共享組別成功!";
                    Files.CicsWriteLog(DateTime.Now.ToString("HH:mm:ss") + "  (" + this.Context.User.Identity.Name + ")  更新共享組別名稱 " + str2 + " 至 " + groupname + "！");
                }
                else
                {
                    this.lbMsgS.Text =(Session["LanguageEn"] == "en-US") ? "Update failed！" : "更新共享組別失敗!";// "更新共享組別失敗!";
                }
                this.GetGroupbyOwnerAndType(this.lbUser.Text.Trim(), "S");
            }
            else
            {
                this.lbMsgS.Text = (Session["LanguageEn"] == "en-US") ? "Update failed,group existed！" : "更新組別失敗，共享組別名稱已存在!";// "更新組別失敗，共享組別名稱已存在!";
            }
            this.lbMsgS.UpdateAfterCallBack = true;
        }
        ...
        private void dgdata4_DeleteCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                this.dgdata4.Columns[6].HeaderText = (Session["LanguageEn"] == "en-US") ? "Delete success！" : "刪除成功";//"刪除成功";
            ...
            {
                this.dgdata4.Columns[6].HeaderText = (Session["LanguageEn"] == "en-US") ? "Delete failed！" : "刪除失敗";//"刪除失敗";
                this.dgdata4.Columns[6].HeaderStyle.ForeColor = Color.Red;
            }
            this.dgdata4.Columns[5].HeaderText = "";
        ...
        private void dgdata4_UpdateCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                this.dgdata4.Columns[5].HeaderText = (Session["LanguageEn"] == "en-US") ? "Update success！" : "更新成功";//"更新成功";
            ...
            {
                this.dgdata4.Columns[5].HeaderText = (Session["LanguageEn"] == "en-US") ? "Update failed！" : "更新失敗";//"更新失敗";
                this.dgdata4.Columns[5].HeaderStyle.ForeColor = Color.Red;
            }
            this.dgdata4.Columns[6].HeaderText = "";
            this.GetMemberByGroupID(this.lbUser.Text.Trim(), this.dplAllGroup.SelectedItem.Value.Trim());
        ...
        private void dgMember_DeleteCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            if (members.DeleteMember(data))
            {
                this.dgMember.Columns[7].HeaderText = (Session["LanguageEn"] == "en-US") ? "Delete success！" : "刪除成功";// "刪除成功";
                this.dgMember.Columns[7].HeaderStyle.ForeColor = Color.Red;
                Files.CicsWriteLog(DateTime.Now.ToString("HH:mm:ss") + "  (" + this.Context.User.Identity.Name + ")  刪除聯絡人 " + str2 + " " + str3 + " " + memberno + " ！");
            }
            else
            {
                this.dgMember.Columns[7].HeaderText = (Session["LanguageEn"] == "en-US") ? "Delete failed！" : "刪除失敗";//"刪除失敗";
                this.dgMember.Columns[7].HeaderStyle.ForeColor = Color.Red;
            }
            this.dgMember.Columns[6].HeaderText = "";
            this.lbMsg6.Text = "";
        ...
        private void dgMember_UpdateCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            if (new GroupMembers().UpdateMember(data))
            {
                this.dgMember.Columns[6].HeaderText =(Session["LanguageEn"] == "en-US") ? "Update success！" : "更新成功";// "更新成功";
            ...
            {
                this.dgMember.Columns[6].HeaderText = (Session["LanguageEn"] == "en-US") ? "Update failed！" : "更新失敗";//"更新失敗";
                this.dgMember.Columns[6].HeaderStyle.ForeColor = Color.Red;
            }
            this.dgMember.Columns[7].HeaderText = "";
            this.lbMsg6.Text = "";
        ...
        private void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Submit1.Value = (Session["LanguageEn"] == "en-US") ? "Upload" : "上傳";
                ...
                if (Users.UserAdminCheck(this.Context.User.Identity.Name))
                {
                    ...
                    if (!this.Page.IsPostBack)
                    {
                        ...
                        if (str == "0")
                        {
                            ...
                            if (AppFlag.DeteleGroupMode == "ALL")
                            {
                                ((Anthem.Button)this.FindControl("btnDeleteP")).Attributes.Add("onclick", "return confirm('" + ((Session["LanguageEn"] == "en-US") ? "Are you sure?" : "確定刪除所有私人組別&聯絡人？") + "');");
                            }
                            else
                            {
                        ...
                        else
                        {
                            switch (str)
                            {
                                ...
                                case "5":
                                    ((Anthem.Button)this.FindControl("btnDeleteMember")).Attributes.Add("onclick", "return confirm('" + (Session["LanguageEn"].ToString () == "en-US"? "Are you sure" : "確定刪除聯絡人")+"？');");
                                    this.panel1.Visible = false;
                                    this.panel2.Visible = false;
                                    this.panel3.Visible = false;
                                    this.panel4.Visible = false;
                                ...
                                case "1":
                                    if (AppFlag.DeteleGroupMode == "ALL")
                                    {
                                        ((Anthem.Button)this.FindControl("btnDeleteS")).Attributes.Add("onclick", "return confirm(' " + ((Session["LanguageEn"] == "en-US") ? "Are you sure?" : "確定刪除所有共享組別&聯絡人?") + " ');");
                                    }
                                    else
                                    {
            ...
            if (str2 != "")
            {
                try
                {
                    ...
                    if (File.Exists(path))
                    {
                        ...
                        {
                            path = AppDomain.CurrentDomain.BaseDirectory.ToString() + centaSmsUploadFolder + str2.Substring(0, str2.LastIndexOf(".XLSX")) + "_" + DateTime.Now.ToString("MMddHHmm") + ".XLSX";
                        }
                        else
                        {
