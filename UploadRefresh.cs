namespace CENTASMS
{
    ...
    public class UploadRefresh : Page
    {
        ...
        private void dgActions_PageIndexChanged(object source, DataGridPageChangedEventArgs e)
        {
            ...
            data = new SmsActions().LoadAllAction("UPLOAD");
            this.dgActions.DataSource = data.Tables["SMS_ACTIONS"].DefaultView;
            this.dgActions.PageSize = 10;
        ...
        private void Page_Load(object sender, EventArgs e)
        {
                ...
                if (base.Request.IsAuthenticated && base.Request.IsAuthenticated)
                {
                    ...
                    switch (doload.State)
                    {
                        ...
                        case 1:
                        {
                            ...
                            SmsActionData data = new SmsActionData();
                            data = new SmsActions().LoadActionByCondition(doload.strcondtion, "UPLOAD");
                            this.dgActions.DataSource = data.Tables["SMS_ACTIONS"].DefaultView;
                        ...
                        case 3:
                        {
                            ...
                            data2 = new SmsActions().LoadActionByCondition(doload.strcondtion, "UPLOAD");
                        ...
                        case 5:
                        {
                            ...
                            data3 = new SmsActions().LoadActionByCondition(doload.strcondtion, "UPLOAD");
            ...
            {
                Files.CicsWriteError(DateTime.Now.ToString("HH:mm:ss") + "   UploadRefresh.Page_Load  " + exception.ToString());
            }
        }
    }
}
