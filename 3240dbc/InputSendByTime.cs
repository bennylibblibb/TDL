namespace CENTASMS
{
    ...
    public class InputSendByTime : Page
    {
        ...
        private void btnSaveData_Click(object sender, EventArgs e)
        {
            ...
            {
                this.schsendload.lang = Session["LanguageEn"].ToString();
                ...
                {
                    this.Page.RegisterStartupScript("", "<script>alert('" + ((Session["LanguageEn"] == "en-US") ? "Please input correct Date time(before " : " 請正確輸入預設發送時間(提前") + AppFlag.CentaSmsSendTime + ((Session["LanguageEn"] == "en-US") ? " Minutes" : "分鐘") + "!)');</script>");
                }
            }
        }
        ...
        private void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                ((Anthem.Button)this.FindControl("btnSaveData")).Attributes.Add("onclick", "return confirm('"+(Session["LanguageEn"].ToString () == "en-US"? "Are you sure？" : "確定預設發送短訊？")+"');");
            }
