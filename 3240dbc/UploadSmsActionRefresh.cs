namespace CENTASMS
{
    ...
    public class UploadSmsActionRefresh : Page
    {
        ...
        private void dgActions_PageIndexChanged(object source, DataGridPageChangedEventArgs e)
        {
            ...
            data = new SmsActions().LoadAllAction("ACTION");
        ...
        private void Page_Load(object sender, EventArgs e)
        {
                ...
                if (base.Request.IsAuthenticated && base.Request.IsAuthenticated)
                {
                    ...
                    switch (doload.State)
                    {
                        ...
                        case 1:
                        {
                            ...
                            SmsActionData data = new SmsActionData();
                            data = new SmsActions().LoadActionByCondition(doload.strcondtion,"ACTION");
                            this.dgActions.DataSource = data.Tables["SMS_ACTIONS"].DefaultView;
                        ...
                        case 3:
                        {
                            ...
                            data2 = new SmsActions().LoadActionByCondition(doload.strcondtion, "ACTION");
                        ...
                        case 4:
                            ...
                            this.divStatus.Visible = false;
                            this.lbResult.Text = "備註：Sec.: " + ((TimeSpan)(DateTime.Now - doload.StartTime)).TotalSeconds.ToString("0") + "s&nbsp;&nbsp;&nbsp;&nbsp;Per: " + doload.Percent.ToString() + "/" + doload.Total.ToString() + "  &nbsp;&nbsp;&nbsp;  Finished.";
                            this.Session["doSmsActionLoad"] = null;
                            break;
                        ...
                        case 5:
                        {
                            ...
                            data3 = new SmsActions().LoadActionByCondition(doload.strcondtion, "ACTION");
            ...
            {
                Files.CicsWriteError(DateTime.Now.ToString("HH:mm:ss") + "   UploadSmsActionRefresh.Page_Load  " + exception.ToString());
            }
        }
    }
}
