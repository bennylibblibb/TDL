...
for(i=1930;i<2029;i++)
	write("<OPTION value='"+i+"'>"+i+" </OPTION>");//YEAR
write("</SELECT>");
write("&nbsp;<select name='tbSelMonth' onChange='fUpdateCal(tbSelYear.value, tbSelMonth.value)' Victor='Won'>");
for (i=0; i<12; i++)
	write("<option value='"+(i+1)+"'>"+gMonths[i]+"</option>");
write("</SELECT>");
write("&nbsp;&nbsp;<span title='Previous  Month' onclick='javascript:fPrevMonth()' onmouseover='this.style.color=gcToggleText' onMouseOut='this.style.color=gcLinkText' style='cursor:hand; font-family:webdings; color:"+gcLinkText+"'>3</span>");
write("<span title='Next Month' onclick='javascript:fNextMonth()' onmouseover='this.style.color=gcToggleText' onMouseOut='this.style.color=gcLinkText' style='cursor:hand; font-family:webdings; color:"+gcLinkText+"'>4</span>");
write("</td>");
write("</TR><TR>");
...
write("<span ID=\"CAL_B_BLANK\" style='color:"+gcLinkText+"; visibility:visible; cursor:hand; font-size:9pt' onclick='fSetDate(0,0,0)' onMouseOver='this.style.color=gcToggleText' onMouseOut='this.style.color=gcLinkText' title=Clear Value>[ Clear ]</span>");

write("<span style='color:"+gcLinkText+";cursor:hand; font-size:9pt' onclick='fSetDate(giYear,giMonth,giDay)' onMouseOver='this.style.color=gcToggleText' onMouseOut='this.style.color=gcLinkText' title=Select Day> [ "+giYear+"-"+giMonth+"-"+giDay+" ]</span>");
write("</td></tr></table>");
write("</TD></TR>");
write("</TABLE></Div>");
}
