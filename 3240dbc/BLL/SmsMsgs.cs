namespace CENTASMS.BLL
{
    ...
    public class SmsMsgs
    {
        ...
        public void DeletelSmsData(string id)
        {
            ...
            OdbcConnection connection = new OdbcConnection(AppFlag.CENTASMSMAININTEConn);
        ...
        private OdbcCommand GetDeleteCommand()
        {
            if (this.deleteCommand == null)
            {
                string cmdText = "DELETE FROM   " + AppFlag.SMS_MSG_TABLE + "   WHERE CBATCHID=? and  CSMSMSG=? and   CTYPE=? and   IPRIORITY =? and   CREATE_DATE=?   ";
                this.deleteCommand = new OdbcCommand(cmdText, new OdbcConnection(AppFlag.CENTASMSMAININTEConn ));
                this.deleteCommand.CommandType = CommandType.Text;
                this.deleteCommand.CommandTimeout = 60 * 2;
                OdbcParameterCollection parameters = this.deleteCommand.Parameters;
                parameters.Add(new OdbcParameter("@CBATCHID", OdbcType.VarChar, 10));
                parameters.Add(new OdbcParameter("@CSMSMSG", OdbcType.VarChar,6120));
                parameters.Add(new OdbcParameter("@CTYPE", OdbcType.VarChar, 1));
                parameters.Add(new OdbcParameter("@IPRIORITY", OdbcType.Int));
                parameters.Add(new OdbcParameter("@CREATE_DATE", OdbcType.Date));
        ...
        private OdbcCommand GetInsertCommand()
        {
            if (this.insertCommand == null)
            {
                ...
                parameters.Add(new OdbcParameter("@CBATCHID", OdbcType.VarChar, 10));
                parameters.Add(new OdbcParameter("@CSMSMSG", OdbcType.VarChar ,6120));
                //parameters.Add(new OdbcParameter("@CMMSSUBJECT", OdbcType.VarChar, 0x9c4));
                //parameters.Add(new OdbcParameter("@CMMSATTACH", OdbcType.VarChar, 0x9c4));
                parameters.Add(new OdbcParameter("@CTYPE", OdbcType.VarChar, 1));
                parameters.Add(new OdbcParameter("@IPRIORITY", OdbcType.Int));
                parameters.Add(new OdbcParameter("@CREATE_DATE", OdbcType.Date));
                parameters["@CBATCHID"].SourceColumn = "CBATCHID";
        ...
        public bool DeleteMmsInfo(string id)
        {
            bool bResult = false;
            string deleteString = "";
            using (OdbcConnection connection = new OdbcConnection(AppFlag.CENTASMSMAININTEConn))
            {
                deleteString = "delete from  "+AppFlag.SMS_MSG_TABLE +" where  CBATCHID='" + id + "'";
                OdbcCommand cmd = new OdbcCommand(deleteString, connection);
                connection.Open();
                cmd.ExecuteNonQuery(); 
        ...
        public static int GetUnSendSms(string id)
        {
            ...
            using (OdbcConnection connection = new OdbcConnection(AppFlag.CENTASMSMAININTEConn))
            {
                ...
                OdbcCommand cmd = new OdbcCommand(selectString, connection);
                connection.Open();
    ...
    public class SmsMsgsAction
    {
        ...
        //        OdbcParameterCollection parameters = this.deleteCommand.Parameters;
        //        parameters.Add(new OdbcParameter("@CBATCHID", OdbcType.VarChar, 10));
        //        parameters.Add(new OdbcParameter("@CSMSMSG", OdbcType.VarChar));
        //        parameters.Add(new OdbcParameter("@CTYPE", OdbcType.VarChar, 1));
        //        parameters.Add(new OdbcParameter("@IPRIORITY", OdbcType.Integer));
        //        parameters.Add(new OdbcParameter("@CREATE_DATE", OdbcType.Date));
        //        parameters["@CBATCHID"].SourceColumn = "CBATCHID";
        //        parameters["@CSMSMSG"].SourceColumn = "CSMSMSG";
        //        parameters["@CTYPE"].SourceColumn = "CTYPE";
