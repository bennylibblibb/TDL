				...
				<tr>
					<td height="30" align="left">
						<DIV id="divView" runat="server" align="left">  &nbsp;<asp:Literal runat="server" Text="<%$ Resources:URClick %>"/> 
							<asp:LinkButton id="lbtnView" runat="server" meta:resourcekey="lbtnViewResource1">記錄 </asp:LinkButton> &nbsp;<asp:Literal runat="server" Text="<%$ Resources:URHistRec %>"/></DIV>
						<DIV id="divStatus" runat="server"> &nbsp;<asp:Literal runat="server" Text="<%$ Resources:URClick %>"/> 
							<asp:LinkButton id="LbtnRefresh" runat="server" meta:resourcekey="LbtnRefreshResource1">刷新 </asp:LinkButton> &nbsp;<asp:Literal runat="server" Text="<%$ Resources:URUploadStauts %>"/></DIV>
					</td>
				</tr>
				<tr align="center">
					<td align="left"><asp:DataGrid id="dgActions" runat="server" AutoGenerateColumns="False" AllowPaging="True" Width="100%" meta:resourcekey="dgActionsResource1">
							...
							<Columns>
								...
								<asp:ButtonColumn Visible="False" Text="刪除" CommandName="Delete" meta:resourcekey="ButtonColumnResource1">
