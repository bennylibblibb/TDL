namespace CENTASMS.UserControl
{
    ...
    public class SignIn : UserControl
    {
        ...
        protected Anthem.RadioButtonList rbLanguages;


        private void rbSelectedIndexChanged(object sender, EventArgs e)
        {
            if (rbLanguages.SelectedValue =="en")
            {
        ...
        private void InitializeComponent()
        {
            this.BtnSignin.Click += new EventHandler(this.Btnsignin_Click); 
             ...
             this.rbLanguages.SelectedIndexChanged += new EventHandler(this.rbSelectedIndexChanged);
        ...
        private void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (Session["LanguageEn"] == "en-US")
                {
                    rbLanguages.SelectedValue = "en";
                    this.lbUserInfo.Text = "Login Information";
                    this.lbUserInfoID.Text = "User Name:";
                    this.lbUserInfoPwd.Text = "Password:";
                    this.lbValidateCode.Text = "Security Code";
