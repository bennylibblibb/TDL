        ...
        { 
                ...
                try
                {
                   ...
                   /// string strCID = dtCreate.ToString("MMddHHmmss");
                    ...
                    if (bResult)
                    {
                        ...
                        {
                            Files.CicsWriteLog(DateTime.Now.ToString("HH:mm:ss") + "  (" + this.dolbUser + ") 上載SMS " + fileName +"成功! （RemoteService）");
                         }
                        else
                        {
                            Files.CicsWriteLog(DateTime.Now.ToString("HH:mm:ss") + "  (" + this.dolbUser + ") 上載SMS " + fileName + "成功! （No RemoteService）");
                        }
                        if (DoAction == true)
                        {
            ...
            finally
            {
                ...
                try
                {
                    ...
                    SmsActionData actiondata = smsaction.LoadActionByCondition(strcondtion,"SMS");
