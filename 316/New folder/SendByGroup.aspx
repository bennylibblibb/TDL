				...
				<tr>
					<td class="top_bar02_bg" vAlign="top" height="15">
						<P align="left"><FONT color="#ffffff"><IMG height="15" src="resource/spacer.gif" width="15"></FONT>
							  <asp:Literal runat="server" Text="<%$ Resources:SGUser %>"/>&nbsp;<asp:label id="lbUser" runat="server" meta:resourcekey="lbUserResource1"></asp:label></P>
					</td>
				</tr>
			</table>
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
			        ...
			        document.getElementById("txtUserPWLogion").value = "";
								    ...
								    <anthem:panel id="plSendMsg" runat="server" Visible="False" meta:resourcekey="plSendMsgResource1">
										<TABLE style="WIDTH: 500px; BORDER-COLLAPSE: collapse; HEIGHT: 380px;" 
											...
											<TR><TD vAlign="top" align="left"  colspan=4  height="1"><anthem:LABEL id="lbMsgLogin" runat="server" ForeColor="Red" meta:resourcekey="lbMsgLoginResource1"></anthem:LABEL><anthem:Button id="btnLoginOut" runat="server" Text="登出" Visible="False" meta:resourcekey="btnLoginOutResource1" ></anthem:Button>&nbsp;</TD></TR>
											<TR vAlign="top" width="100%">
                                                <TD vAlign="top" align="left" width="40%" height="1" ><anthem:Label id="lbSendSMS" runat="server" Font-Size="Medium" meta:resourcekey="lbSendSMSResource1">短訊內容：</anthem:Label>  <asp:RequiredFieldValidator id="rfvMsg" runat="server" ErrorMessage="|" ControlToValidate="txtSmsContent" Enabled="False" meta:resourcekey="rfvMsgResource1"></asp:RequiredFieldValidator><anthem:Label id="lbrfvContent" runat="server" Visible="False" ForeColor="Red" meta:resourcekey="lbrfvContentResource1">*</anthem:Label></TD>
                                                <TD vAlign="top" align="left" width="24%" height="1"><anthem:Label id="lbSendNo" runat="server" Font-Size="Medium" meta:resourcekey="lbSendNoResource1">發送號碼：</anthem:Label> <asp:RequiredFieldValidator id="rfvNum" runat="server" ErrorMessage="|" ControlToValidate="tbNum" Enabled="False" meta:resourcekey="rfvNumResource1"></asp:RequiredFieldValidator><anthem:Label id="lbrfvNum" runat="server" Visible="False" ForeColor="Red" meta:resourcekey="lbrfvNumResource1">*</anthem:Label><INPUT type="checkbox" style="DISPLAY: none" id="ckIdd"  onclick="checkIdd()"><FONT face="新細明體"  style="DISPLAY: none" id="valueIDD">IDD</FONT></TD>
                                                <TD vAlign="top" align="left" width="18%" height="1"><anthem:Label id="lbSendGroup" runat="server" Font-Size="Medium" meta:resourcekey="lbSendGroupResource1">發送組別：</anthem:Label></TD>
                                                <TD vAlign="top" align="left" width="18%" height="1"><anthem:Label id="lbSendMember" runat="server"   Font-Size="Medium" meta:resourcekey="lbSendMemberResource1">發送組員：</anthem:Label></TD>
                                                <TR width="100%">
                                            ...
                                            <TR width="100%"><TD vAlign="top" align="left" width="50%" height="1">                         <br />
                                                <asp:Literal runat="server" Text="<%$ Resources:SSMsgTotal %>"/> <anthem:Label id="lbLen" runat="server" ForeColor="Red" Width="40px" meta:resourcekey="lbLenResource1">0</anthem:Label><asp:Literal runat="server" Text="<%$ Resources:SSMsgTotal2 %>"/><anthem:Label id="lbNum" runat="server" ForeColor="Red" Width="20px" meta:resourcekey="lbNumResource1">0</anthem:Label><asp:Literal runat="server" Text="<%$ Resources:SSMsgTotal3 %>"/>  <anthem:Label id="lbMsg" runat="server" ForeColor="Red"  Width="128px" meta:resourcekey="lbMsgResource1"></anthem:Label><asp:Button id="btnCount" runat="server" Visible =False   Text="計算長度" meta:resourcekey="btnCountResource1"></asp:Button></TD><TD></TD><TD vAlign="top" align="left" width="28%" height="1"><FONT face="新細明體"></FONT></TD><TD vAlign="top" align="left" width="22%" height="1"><FONT face="新細明體"></FONT></TD></TR>
                                              <TR><TD vAlign="baseline" align="left" width="50%" height="1"><P> 
                                                  ...
                                                  <TD></TD>
                                                  <TD vAlign="top" align="left" width="28%" height="1"></TD><TD vAlign="top" align="left" width="22%" height="1"></TD></TR>
                                            <TR ><TD  align="left" width="50%" height="1"><table  ><tr ><td  ><anthem:Button id="btnSend" runat="server" Text="發送" meta:resourcekey="btnSendResource1"></anthem:Button></td><td vAlign="top" align=left  width="200px"  ><DIV  id="div_load" runat="server"   ><IFRAME  id ="sendiframe" src="sendRefresh.aspx"  frameborder=no  scrolling =no  width ="200px" height ="60px"  ></iframe></div></td><td  align=left  ><asp:Button id="btnCannel" runat="server"  Text="重置" meta:resourcekey="btnCannelResource1"></asp:Button></td></tr></table></TD><TD></TD><TD vAlign="top" align="left" width="28%" height="1"></TD><TD vAlign="top" align="left" width="22%" height="1"><FONT face="新細明體"><INPUT id="btnCCannel" style="DISPLAY: none" onclick="Clear()" type="button" value="重置"></FONT></TD></TR>
										</TABLE>
									</anthem:panel>
											...
											<TR vAlign="middle" width="100%">
												...
												<TD align="left" height="1"><asp:Literal runat="server" Text="<%$ Resources:SGUser %>"/>
													...
													<anthem:DropDownList id="dplUsers" runat="server" Width="100px" AutoCallBack="True" meta:resourcekey="dplUsersResource1">
														<asp:ListItem Value="All" Selected="True" meta:resourcekey="ListItemResource2">All</asp:ListItem>
                                    ...
                                    <asp:panel id="plSendHist" runat="server" Visible="False" meta:resourcekey="plSendHistResource1">
										<TABLE style="WIDTH: 100%; BORDER-COLLAPSE: collapse; HEIGHT: 380px;"
											cellSpacing="10" cellPadding="0" rules="none" align="left" border="0">
											<TR vAlign="middle" width="100%">
												<TD vAlign="baseline" align="left" height="1"><STRONG><asp:Literal runat="server" Text="<%$ Resources:SGSclMsg %>"/></STRONG>
												</TD>
												<TD align="left" height="1"><asp:Literal runat="server" Text="<%$ Resources:SGUser %>"/>
													...
													<anthem:DataGrid id="dgSchedule2" runat="server" Visible="False" Width="98%" AllowPaging="True"
														...
														<Columns>
                                                            ...
                                                            <asp:TemplateColumn HeaderText="<%$ Resources:SGSmsContent %>">
                                                                ...
                                                                <HeaderStyle CssClass="grid-header" HorizontalAlign="Left" VerticalAlign="Middle" Wrap="False" />
                                                               <ItemStyle CssClass="grid-item" Width="250px"  Wrap="true"/>
                                                            </asp:TemplateColumn>
                                                            <asp:TemplateColumn HeaderText="<%$ Resources:SGSmsLen %>">
                                                                <ItemTemplate>
                                                                    <%# DataBinder.Eval(Container, "DataItem.IMSGLEN") %>
											...
											<TR vAlign="bottom">
											 ...
											 <TD vAlign="bottom" align="left" width="20px">	<asp:CheckBox ID="chkDefault" Runat =server Text ="Default" meta:resourcekey="chkDefaultResource1" > </asp:CheckBox>
												...
												<TD  vAlign=bottom Width="600px" >
													...
													<anthem:LABEL id="lbMsgS" runat="server" Width="200px" ForeColor="Red" meta:resourcekey="lbMsgSResource1"></anthem:LABEL></FONT><FONT face="新細明體"></FONT><FONT face="新細明體"></FONT>
													</TD>
											</TR>
											<TR>
												<TD vAlign="bottom" align="left" height="1"></TD>
                                    ...
                                    <TABLE class="tan-border02" style="WIDTH: 100%; BORDER-COLLAPSE: collapse;  HEIGHT: 100%;vertical-align:top"
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" height="23" style="HEIGHT: 23px;WIDTH: 100px;">
                                                    <asp:CheckBox ID="chkAction" runat="server" meta:resourcekey="chkActionResource1" Text="With Account Action" Visible="False" Width="160px" />
                                                </td>
                        ...
                        ：</ASP:LABEL></TD>
															...
															<TR bgColor="#edecd1" height="1">
																...
																<TD align="right" height="1"><FONT face="新細明體"></FONT></TD>
																<TD align="left" colSpan="3" height="1"><FONT face="新細明體">&nbsp;&nbsp;
																		<anthem:LABEL id="lbUploadResult2" runat="server" Visible="False" Width="100%" ForeColor="Red" meta:resourcekey="lbUploadResult2Resource1"></anthem:LABEL></FONT></TD>
																<TD align="left" height="1"></TD>
															</TR>
															<TR>
																<TD style="WIDTH: 10px" height="1"></TD>
												...
												<TD align="center" colSpan="3" height="1"><FONT face="新細明體">
														<TABLE id="Table6" borderColor="#edecd1" height="100%" cellSpacing="1" cellPadding="0"
															...
															<TR style ="display:none">
																<TD vAlign="baseline" align="left" height="1"></TD>
																<TD align="right" height="1">
																	<ASP:LABEL id="lbAgentUpload" runat="server" Width="112px" Font-Bold="True" meta:resourcekey="lbAgentUploadResource1">上傳方式 
                        ：</ASP:LABEL></TD>
																<TD style="WIDTH: 118px" align="left" height="1">
															...
															<TR bgColor="#edecd1" height="1">
																...
																<TD align="right" height="1"><FONT face="新細明體"></FONT></TD>
																<TD align="left" colSpan="3" height="1"><FONT face="新細明體">&nbsp;&nbsp;
																		<anthem:LABEL id="lbUploadResult3" runat="server" Visible="False" Width="100%" ForeColor="Red" meta:resourcekey="lbUploadResult3Resource1"></anthem:LABEL></FONT></TD>
																<TD align="left" height="1"></TD>
															</TR>
															<TR>
																<TD style="WIDTH: 10px" height="1"></TD>
