									...
									<TABLE style="WIDTH: 100%; BORDER-COLLAPSE: collapse; HEIGHT: 380px" class="tan-border01"
										...
										<TR   width="100%">
											...
											<TD vAlign="bottom"  align="left" height="1"> <asp:Literal runat="server" Text="<%$ Resources:SSUser %>"/>
												<anthem:DropDownList id="dplUsers" runat="server" Width="80px" AutoCallBack="True" meta:resourcekey="dplUsersResource1">
                                        ...
                                        <TR style="height:20px ">
											<TD vAlign="bottom" align="left"   height="1"   colspan="5"><hr/></TD>
										</TR>
										<TR width="100%">
