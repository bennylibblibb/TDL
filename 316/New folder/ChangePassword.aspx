<%@ Page language="c#" Codebehind="ChangePassword.aspx.cs" AutoEventWireup="false" Inherits="CENTASMS.ChangePassword" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
				...
				<tr>
					<td class="top_bar02_bg" vAlign="top" height="15">
						<P align="left"><FONT color="#ffffff"><IMG height="15" src="resource/spacer.gif" width="15"></FONT>
							 <asp:Literal runat="server" Text="<%$ Resources:CPUser %>"/> &nbsp;<asp:label id="lbUser" runat="server" meta:resourcekey="lbUserResource1"></asp:label></P>
					</td>
				</tr>
			</table>
									...
									<TABLE class="tan-border01" cellSpacing="10" cellPadding="0" rules="none" align="left"
										...
										<TR width="100%">
											<TD vAlign="top" align="center" width="50%" colSpan="5" height="256"><FONT face="新細明體">
													<anthem:panel id="plSendMsg" runat="server" meta:resourcekey="plSendMsgResource1">
														<TABLE id="Table2" style="WIDTH: 399px; HEIGHT: 182px" height="182" cellSpacing="0" cellPadding="0"
															...
															<TR>
																...
																<TD style="HEIGHT: 30px">
																	<ASP:LABEL id="lbpw" runat="server" meta:resourcekey="lbpwResource1">新密碼：</ASP:LABEL></TD>
															</TR>
															<TR>
																...
																<TD style="HEIGHT: 30px">
																	<ASP:TEXTBOX id="txtPW" runat="server" TextMode="Password" MaxLength="11" CssClass="safari-midtextbox"
																		Width="200px" meta:resourcekey="txtPWResource1"></ASP:TEXTBOX>
																	<ASP:REQUIREDFIELDVALIDATOR id="rfvPW" runat="server" ControlToValidate="txtPW" ErrorMessage="＊" meta:resourcekey="rfvPWResource1"></ASP:REQUIREDFIELDVALIDATOR></TD>
															</TR>
															<TR>
																<TD style="HEIGHT: 30px" width="14">&nbsp;</TD>
																<TD style="HEIGHT: 30px">
																	<ASP:LABEL id="lbConfirm" runat="server" meta:resourcekey="lbConfirmResource1">確認密碼：</ASP:LABEL></TD>
															</TR>
															<TR vAlign="top">
																...
																<TD style="HEIGHT: 35px">
																	<ASP:TEXTBOX id="txtPW2" runat="server" TextMode="Password" MaxLength="21" CssClass="safari-midtextbox"
																		Width="200px" meta:resourcekey="txtPW2Resource1"></ASP:TEXTBOX>
																	<ASP:REQUIREDFIELDVALIDATOR id="rfvPW2" runat="server" ControlToValidate="txtPW2" ErrorMessage="＊" meta:resourcekey="rfvPW2Resource1"></ASP:REQUIREDFIELDVALIDATOR>
																	<ASP:COMPAREVALIDATOR id="cvPW" runat="server" ControlToValidate="txtPW2" ErrorMessage="Passwords Do Not Match. "
																		ControlToCompare="txtPW" meta:resourcekey="cvPWResource1"></ASP:COMPAREVALIDATOR></TD>
															</TR>
															<TR>
																<TD style="HEIGHT: 25px" width="14">&nbsp;</TD>
																<TD style="HEIGHT: 25px">
																	<anthem:BUTTON id="Save" runat="server" Width="64px" Text="保存" meta:resourcekey="SaveResource1"></anthem:BUTTON>&nbsp;&nbsp;&nbsp;<INPUT id="btnCannel"  runat="server" onclick="Clear()" type="button" value="重置" name="btnCannel">&nbsp;&nbsp;
																	<anthem:LABEL id="lbMsg" runat="server" ForeColor="Red" meta:resourcekey="lbMsgResource1"></anthem:LABEL></TD>
															</TR>
														</TABLE>
