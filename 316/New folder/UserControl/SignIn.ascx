...
<table cellSpacing="0" cellPadding="0" border="0" style="height: 250px; width: 100px">
	...
	<TR>
		<TD></TD>
		<TD style ="height:30px;vertical-align:bottom"><STRONG> <asp:Label  id="lbValidateCode" runat="server" cssclass="chrome-lable" width="200px" Font-Size="Small" >驗證碼:</asp:Label></STRONG>
		</TD>
	</TR>
	<TR>
		<TD></TD>
