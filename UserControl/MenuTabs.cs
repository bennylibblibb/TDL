namespace CENTASMS.UserControl
{
    ...
    public class MenuTabs : UserControl
    {
        ...
        private void Page_Load(object sender, EventArgs e)
        {
            ...
            list.Add(new TabItem( Session["LanguageEn"] == "en-US" ?"Send Group SMS":"群組發送", Global.GetApplicationPath(base.Request) + "/SendByGroup.aspx?csIndex=" + list.Count));
            ...
            {
                list.Add(new TabItem(Session["LanguageEn"] == "en-US" ? "Manage Group" : "組別管理", Global.GetApplicationPath(base.Request) + "/GroupAdmin.aspx?csIndex=" + list.Count));
                list.Add(new TabItem(Session["LanguageEn"] == "en-US" ? "Manage User" : "用戶管理", Global.GetApplicationPath(base.Request) + "/UserMaintenance.aspx?csIndex=" + list.Count));
            ...
            list.Add(new TabItem(Session["LanguageEn"] == "en-US" ? "Statistical Data" : "短訊統計", Global.GetApplicationPath(base.Request) + "/StatSms.aspx?csIndex=" + list.Count));
            //if (Users.UserCheck(name))
            //{
            list.Add(new TabItem(Session["LanguageEn"] == "en-US" ? "Change Password" : "更改密碼", Global.GetApplicationPath(base.Request) + "/ChangePassword.aspx?csIndex=" + list.Count));
            //}
            //else
            //{
            //    list.Add(new TabItem("", ""));
            //}
            list.Add(new TabItem(Session["LanguageEn"] == "en-US" ? "Log Out" : "登出", Global.GetApplicationPath(base.Request) + "/Logout.aspx?csIndex=" + list.Count));
