namespace CENTASMS
{
    ...
    public class UserMaintenance : CommonPage
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                this.lbMsgD.Text = (Session["LanguageEn"] == "en-US") ? "Update success！" : "刪除成功";//"刪除成功！";
            ...
            {
                this.lbMsgD.Text = (Session["LanguageEn"] == "en-US") ? "Update failed！" : "刪除失敗" ;//"刪除失敗！";
            }
        ...
        private void btnNewUser_Click(object sender, EventArgs e)
        {
            ...
            {
                this.lbMsg.Text = (Session["LanguageEn"] == "en-US") ? "Update success！" : "新增用戶成功!";// "新增用戶成功!";
            ...
            {
                this.lbMsg.Text = (Session["LanguageEn"] == "en-US") ? "Update failed！UserID existed" : "新增用戶失敗，用戶登錄名已存在!";// "新增用戶失敗，用戶ＩＤ已存在!";
            }
        ...
        private void btnNewUserU_Click(object sender, EventArgs e)
        {
            ...
            {
                str = (Session["LanguageEn"] == "en-US") ? "N" : "無"; //"無";
            }
            else
            {
                str = (Session["LanguageEn"] == "en-US") ? "Y" : "有"; //"有";
            }
            ...
            {
                this.lbMsgU.Text = (Session["LanguageEn"] == "en-US") ? "Update success！" : "更新用戶成功!";//"更新用戶成功!";
            ...
            {
                this.lbMsgU.Text = (Session["LanguageEn"] == "en-US") ? "Update failed！" : "更新用戶失敗!";// "更新用戶失敗!";
            }
