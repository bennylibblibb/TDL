...
<%@ Page language="c#" Codebehind="AlertSmsData.aspx.cs" AutoEventWireup="false" Inherits="CENTASMS.AlertSmsData"  ValidateRequest="false" %>
			...
			<TABLE align="center">
				...
				<TR align="center">
					<TD align="center"><anthem:textbox onkeypress="CountSmsContent()" id="txtSmsContent" onkeydown="CountSmsContent()"
							...
							Width="380px" Height="280px"></anthem:textbox><FONT face="穝灿砰"></FONT></TD>
				</TR>
				<TR>
					<TD vAlign="top" align="left" style="DISPLAY: none" >
						<anthem:label id="lbLen" runat="server" Width="10px" ForeColor="Red">0</anthem:label>じ祏癟だ
						<anthem:label id="lbNum" runat="server" Width="10px" ForeColor="Red">0</anthem:label>兵祇癳
						<asp:TextBox id="txtoldcontent" runat="server" Visible="False"></asp:TextBox>
					<TD></TD>
				<TR>
					<TD align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<anthem:button id="btnUpdate" runat="server" Text="э"></anthem:button>&nbsp;
						<anthem:label id="lbMsg" runat="server" Width="130px" ForeColor="Red"></anthem:label><INPUT onclick="window.close();" type="button" value="闽超">
					</TD>
				</TR>
			</TABLE>
		</FORM>
