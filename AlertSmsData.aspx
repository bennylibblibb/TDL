...
function CountSmsBig5(nLen){
    ...
    if (nLen == 0)
      ...
      return 10;
    else { document.getElementById("lbMsg").innerHTML = '<%= GetLocalResourceObject("ASDMoreThan2").ToString() %>' }                                              
...
function CountSmsNoBig5(nLen) {
    ...
    ////else if (nLen <= 1530)      
    ////  return 10;                                              
    else { document.getElementById("lbMsg").innerHTML = '<%= GetLocalResourceObject("ASDMoreThan").ToString() %>' }          
    return 0;                                                    
}
		</script>
	</HEAD>
			...
			<TABLE align="center">
				...
				<TR align="center">
					<TD align="center"><anthem:textbox onkeypress="CountSmsContent()" id="txtSmsContent" onkeydown="CountSmsContent()"
							...
							Width="380px" Height="280px" meta:resourcekey="txtSmsContentResource1"></anthem:textbox><FONT face="新細明體"></FONT></TD>
				</TR>
				<TR>
					...
					<TD></TD>
				<TR>
					<TD align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<anthem:button id="btnUpdate" runat="server" Text="更改" meta:resourcekey="btnUpdateResource1"></anthem:button>&nbsp;
						<anthem:label id="lbMsg" runat="server" Width="130px" ForeColor="Red" meta:resourcekey="lbMsgResource1"></anthem:label><INPUT   id="btnCannel"  runat="server"  onclick="window.close();" type="button" value="關閉" meta:resourcekey="SSMsgTotal3"  >
					</TD>
				</TR>
			</TABLE>
		</FORM>
